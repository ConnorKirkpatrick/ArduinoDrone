...
double kalAngleX, kalAngleY, kalHeading; // Calculated angle using a Kalman filter
...
void kalmanUpdate(attitude currentAttitude,double heading, double dt){
    ...
    kalHeading = kalmanZ.getAngle(heading, currentAttitude.RAccZ, dt);
